...
*/
/* $(document).ready(function(){// Find value of selected radio button.
...
*/ 
    ...
    var addItem = $('addItem');
    addItem.addEventListener("click", getData);
    var inspect = $('inspect');
    inspect.addEventListener("click", editItem);
