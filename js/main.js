 ...
 */    
   ...
   // Create edit/delete links for each Local Storage Item.
    ...
    var validate = function (e) {
        ...
        errMsg.innerHTML = "";
        getYear.style.border = "2px solid black";
        getManufacturer.style.border = "2px solid black";
        getLastOilDate.style.border = "2px solid black";
        ...
        if(getYear.value === "" || getYear.value < 1955 || getYear.value > 2012) {
            ...
            getYear.style.border = "2px solid red";
